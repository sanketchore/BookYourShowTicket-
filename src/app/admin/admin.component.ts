...
export class AdminComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'movieName', 'theatreName', 'noOfTicketsAllotted', 'noOfTicketsSold', 'ticketStatus', 'star'];
  allMovies: any = [];
  ...
  public updateTicketStatus(movieName: string,theatreName:string) {
    this.api.updateTicketStatus(movieName,theatreName).subscribe(
      (response) => {
        this.getAllMovies();
